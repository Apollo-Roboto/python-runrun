...
class BaseCommand:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if (
            ...
            or self.command_display_name != other.command_display_name
            or self.command_description != other.command_description
            or self.command_aliases != other.command_aliases
        ):
            return False
...
class Context:
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return (
            self.root_command == other.root_command
            and self.original_arguments == other.original_arguments
            and self.scoped_arguments == other.scoped_arguments
            and self.parent_command == other.parent_command
        )
