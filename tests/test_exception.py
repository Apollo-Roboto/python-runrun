...
class TestDefaultExceptionHandler(unittest.TestCase):
    ...
    def test_get_argument_suggestions_pass(self):
        ...
        for unknown, expected_matches in [
            ...
            exception = UnknownArgumentException(
                command=command, unknown_argument=unknown
            )

            returned_suggestions = default_exception_handler.get_argument_suggestions(
                exception
            )
    ...
    def test_get_argument_suggestions_no_match_pass(self):
        ...
        exception = UnknownArgumentException(
            command=command, unknown_argument="--shouldnotmatch"
        )
    ...
    def test_get_sub_command_suggestions_pass(self):
        ...
        for unknown, expected_matches in [
            ...
            returned_suggestions = (
                default_exception_handler.get_sub_command_suggestions(exception)
            )
    ...
    def test_get_sub_command_suggestions_no_match_pass(self):
        ...
        returned_suggestions = default_exception_handler.get_sub_command_suggestions(
            exception
        )
