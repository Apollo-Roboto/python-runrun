...
class TestHelpCommand(unittest.TestCase):
    ...
    def test_get_usage_one_positional_pass(self):
        class RootCommand(BaseCommand):
            ...
            help = HelpCommand()
            arg = Argument(int, "arg", position=0)
    ...
    def test_get_usage_two_positional_correct_order_pass(self):
        class RootCommand(BaseCommand):
            ...
            help = HelpCommand()
            arg1 = Argument(int, "arg1", position=1)
            arg2 = Argument(str, "arg2", position=0)
            arg3 = Argument(str, "arg3", position=3)
            arg4 = Argument(str, "arg4", position=2)
